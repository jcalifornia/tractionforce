...
of the stress is within given cell boundaries.
 We see that 
all forms of regularization recover the signal due to the four pads. The
reconstruction using the
isotropic $L^1$ penalty is seen to be more sparse than that of the
isotropic $L^1$ penalty.
%
%that 
...
joining the ends of the plot. In Fig.~\ref{LAMBDA}, the chosen value
...
this particular value of $\lambda$ is shown in Fig.~\ref{COMPARE}. 
Each row in
...
\caption{\textbf{Choice of $\lambda$} by plotting the tradeoff between regularity and data mismatch.}
\label{LAMBDA}
\end{figure}
