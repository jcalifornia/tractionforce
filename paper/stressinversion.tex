...
Let $\tilde{\bsigma}$ be an affine approximation to $\bsigma\in C^2(\Omega)$, and $\tilde{\u}$ be the corresponding displacement field completed from the approximate stress field. Then, 
\begin{equation}
