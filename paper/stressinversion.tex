...
the \texttt{ecos} solver.  Our implementation can be found at
...
\begin{equation}
\sigma_{rz}(r,\theta) = f_{r} \sin m\theta.\,\, \sigma_{\theta z}(r,\theta) = f_{\theta} \cos n\theta,
\end{equation}
%
...
{\underbrace{\left(  \frac{2\r\cdot\r' - |\r'|^2}{|\r|^2} \right)}_{\mathcal{O}(|\r|^{-1})}}^k,
\end{align} 
